...
class MechanicalHistoryOrders extends StatelessWidget {
  MechanicalHistoryOrders({super.key});
  ...
  changePage(int page) async {
    await Get.find<OrderController>().getOrdersList(
        page: page.toString(),
        category: MainCategory.MECHANICAL,
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<OrderController>(builder: (orderController) {
      // mechanicalController.getMechanicalHistoryOrders('1');
      return SizedBox(
