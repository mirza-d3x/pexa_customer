...
class OrderScreenChild extends StatelessWidget {
  final bool? newUser;
  ...
  /*const OrderScreenChild({Key? key,}) : super(key: key);*/

  @override
  Widget build(BuildContext context) {
    return Container(
      child: orderHeader(context),
    );
  }

  orderHeader(BuildContext context) {
    return Column(
      children: [
        AppBar(
