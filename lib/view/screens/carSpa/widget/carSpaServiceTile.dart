...
class CarSpaServiceTile extends StatefulWidget {
  const CarSpaServiceTile({super.key, this.carSpaServiceResultData, this.index});
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        print(widget.index);
        craSpaController.carSpaAddOnTotal.value = widget.carSpaServiceResultData!.price as int;
        craSpaController
                       ...
                       child: Container(
                         decoration: BoxDecoration(
                           image: DecorationImage(
                               image: NetworkImage(
                                   widget.carSpaServiceResultData!.imageUrl![0])),
                         )
                       )
                       /* child: YoutubePlayer(
                      ...
                      child: Column(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Text(widget.carSpaServiceResultData!.name!,
                                  maxLines: 1,
                            ...
                            SizedBox(
                                ...
                                child: ListView.builder(
                                    itemCount: (craSpaController
                                        ...
                                        ? 3
                                        : craSpaController
                                            .carSpaServiceProperty[widget.index!].length,
                                    shrinkWrap: true,
                ...
                ((widget.carSpaServiceResultData!.description != 'test') &&
                    ...
                    ? Positioned(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              widget.carSpaServiceResultData!.description.toString(),
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Center(
                          child: Text("Book Now",style: veryverySmallFontW600(Colors.black),),
                        ),
                      ),
                      const SizedBox(width: 10,),
                     /* GestureDetector(
                          onTap:(){
                            wishlistController.addTowishlist(craSpaController
                                .carSpaServiceProperty[widget.index!]);
                          },
