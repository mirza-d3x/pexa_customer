...
class ViewAllProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: GetBuilder<ProductCategoryController>(
                                            ...
                                            return currentLocationController
                                                ...
                                                ? Text(
                                                    ('${currentLocationController.userLocationString!.split(',')[0]},${currentLocationController.userLocationString!.split(',')[1]}')
                                                                .length >
                                                            20
                                                        ? '${('${currentLocationController.userLocationString!.split(',')[0]},${currentLocationController.userLocationString!.split(
                                                                        ',')[1]}')
                                                                .substring(
                                                                    0, 19)}...'
