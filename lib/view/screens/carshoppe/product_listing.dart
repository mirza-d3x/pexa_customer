...
import 'package:shoppe_customer/view/screens/dashboard/bottomnew.dart';
                                          ...
                                          onTap: () {
                                            if (index == 0) {
                                              Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                    builder: (context) =>
                                                        const ViewAllCategoryOfProduct(),
                                                  ));
                                            } else {
