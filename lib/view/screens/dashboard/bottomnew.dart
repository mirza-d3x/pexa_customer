          ...
          child: BottomNavigationBar(
            ...
            items: [
              BottomNavigationBarItem(
                activeIcon: Image.asset(Images.home_active,scale: 2.5,),
                  icon: Image.asset(Images.home,scale: 2.5,),
                  label: "Home",
              ),
              BottomNavigationBarItem(
                activeIcon: Image.asset(Images.order_active,scale: 2.5,),
                icon: Image.asset(Images.order,scale: 2.5,),
                label: "Order",
              ),
              BottomNavigationBarItem(
                activeIcon: Image.asset(Images.cart_active,scale: 2.5,),
                icon: Image.asset(Images.cart,scale: 2.5,),
                label: "Cart",
              ),
              BottomNavigationBarItem(
                activeIcon: Image.asset(Images.supports_active,scale: 2.5,),
                icon: Image.asset(Images.supports,scale: 2.5,),
                label: "Support",
              ),
              BottomNavigationBarItem(
                activeIcon: Image.asset(Images.account_active,scale: 2.5,color: Colors.black,),
                icon: Image.asset(Images.account,scale: 2.5,color: Colors.black12,),
                label: "Profile",
              ),
