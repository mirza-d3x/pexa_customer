...
class NoOfferErrorScreen extends StatelessWidget {
  const NoOfferErrorScreen({super.key, this.isOffer = false});
  final bool isOffer;
  @override
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset(
                        isOffer ? Images.no_offer_icon : Images.no_coupon_icon,
                        height: height * 0.22,
                      ),
                      SizedBox(
                        height: height * 0.015,
                      ...
                      Text(
                        isOffer
                            ? "Look like you haven't any offers"
                            : "Look like no coupons are available as this moment",
                        style: defaultFont(
                            color: Colors.black,
                            size: 15,
